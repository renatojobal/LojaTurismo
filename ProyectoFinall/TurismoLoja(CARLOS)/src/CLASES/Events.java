...
public class Events {
    ...
    public String toString() {
        return "Events{" + "idEvents=" + idEvents + ", name=" + name + ", cost=" + cost + ", date=" + date + ", hour=" + hour + ", minutes=" + minutes + ", description=" + description + ", category=" + category + ", place=" + place + ", state=" + state + '}';
    }
